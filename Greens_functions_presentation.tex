...
\note{
    \begin{itemize}
    \item
        This is intended as a short overview of Green's functions for electrical engineers.
    \item
        Green's functions are a huge subject: we will try to demonstrate the most important techniques and ideas.
    \item
