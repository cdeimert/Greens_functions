...
\note{
    ...
    \item
        ...
        Unfortunately means that this presentation will be missing a lot.
    \item
        We'll only cover a few topics, but we'll try to cover them fairly rigorously.
        Should give a solid foundation for reading books on the topic.
    \item
...
\label{sec:constructing_solutions}
