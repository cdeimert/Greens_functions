...
\item
    ...
    In this function we'll look at some properties Green's function under certain special circumstances.
\end{itemize}
}
...
\item
    Example: can use these properties to find the Green's function of the free space wave equation more easily.
\end{itemize}
}
